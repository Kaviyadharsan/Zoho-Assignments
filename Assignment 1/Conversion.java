public class Conversion {
    ...
    public static void main(String[] args) {
        ...
        int intNumber = (int) floatNumber; // Casting float to int
        ...
        float floatNumber2 = (float) doubleNumber; // Casting double to float
        ...
        // int to short
        int intValue = 500;
        short shortValue = (short) intValue; // Casting int to short
